 ...
 * - Provider API keys stored in Cloudflare Dashboard (NOT in Worker code or secrets)
 * - Worker authenticates to AI Gateway using GATEWAY_TOKEN
 * - AI Gateway retrieves provider keys from Cloudflare Secrets Store at runtime
...
export class ProviderFactory {
	 ...
	 * No API key check - key stored in Cloudflare Dashboard
	 */
